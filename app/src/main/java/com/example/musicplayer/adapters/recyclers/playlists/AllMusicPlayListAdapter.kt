...
class AllMusicPlayListAdapter (activity: Activity, lifecycleOwner: LifecycleOwner, playListName : String) :
    RecyclerView.Adapter<AllMusicPlayListAdapter.MyViewHolder>() {
    ...
    @SuppressLint("UseCompatLoadingForDrawables")
    private val blueDisk = activity.resources.getDrawable(R.drawable.main_disk)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val textArtistsName = holder.textArtistsName
        ...
        /* Artists Name Text */
        textArtistsName.text = musicArtists
        ...
        parent.setOnClickListener {
            ...
            mainViewModel.setPlayingListEntity(musics)
            mainViewModel.setPlayingSongEntity(playingSongEntity)


                // ActivitySwitcher.switchToMainActivitys(this.activity, PlayerActivity::class.java,null)
            ActivitySwitcher.switchToMainActivitys(this.activity, ExoPlayerActivity::class.java,null)
        ...
        likeImage.setOnClickListener {
            val addingState =
                mainViewModel.addSongToPlayList(arrayListOf(PlayListsChangeEntity(0,"Liked Songs" , "Normal")), arrayListOf(music))

            if (addingState ) {
                animationStart(it as ImageView, music, "Towward")
            }
            if (!addingState) {
                animationStart(it as ImageView, music, "TurnBack")
            }
